...
router.get("/sign-out", authenticationMiddleware(), async (req, res, next) => {
    await Promise.resolve().then(async () => {
...
router.post("/send-password-link", async (req, res, next) => {
    await Promise.resolve().then(async () => {
...
router.get("/forgot-password/:userId/:token", async (req, res, next) => {
    await Promise.resolve().then(async () => {
        const schema = joi.object().keys({
...
router.post("/rest-password/:userId/:token", async (req, res, next) => {
    await Promise.resolve().then(async () => {
        const { userId, token } = req.params;
